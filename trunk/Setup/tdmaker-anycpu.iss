...
Source: ..\TDMakerGUI\bin\Release\*.dll; DestDir: {app}; Flags: ignoreversion recursesubdirs
...
[Run]
Filename: {app}\{#ExeName}.exe.; Description: {cm:LaunchProgram,TDMaker}; Flags: nowait postinstall skipifsilent
